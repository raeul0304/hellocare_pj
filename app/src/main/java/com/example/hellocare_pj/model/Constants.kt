...
class Constants {
    fun getHealthData():ArrayList<HealthData>{
        val healthinfoList= ArrayList<HealthData>()
        val hinfo1 = HealthData("Q. 빈대에 물리면 어떤 증상이 나타나나요?",
        ...
        val hinfo2 = HealthData("두번째", "이건 그냥 써보자")
